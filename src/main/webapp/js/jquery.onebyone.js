...
(function($) {	
    ...
    $.fn.oneByOne = function(options) {  
		...
		function tweenTo(n){  
			if(n==0){
				$("#indexflash").css("background","#170710");
				$("#subindexflash").css("background","#170710");
			}else if(n==1){
				$("#indexflash").css("background","#f5bb26");
				$("#subindexflash").css("background","#f5bb26");
			}else if(n==2){
				$("#indexflash").css("background","#c7bdb0");
				$("#subindexflash").css("background","#c7bdb0");
			}
