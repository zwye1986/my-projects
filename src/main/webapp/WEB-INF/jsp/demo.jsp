...
<link rel="stylesheet" type="text/css" href="${ctx }/css/jqueryui/jqueryui.css" />
<style>

body {
	background:url('${ctx}/images/turnplate/bg_01.jpg') top center no-repeat #fff;
...
#turnplatewrapper {
	height:592px;
	width:592px;
	background:url('${ctx}/images/turnplate/plate_06.png') top left no-repeat;
...
#turnplate {
	height:592px;
	width:592px;
	background:url('${ctx}/images/turnplate/plate_05.png') top left no-repeat;
...
#turnplate #awards {
	...
	width:100%;
	height:100%;
	background:url('${ctx}/images/turnplate/plate_03.png') top left no-repeat;
...
#platebtn {
	...
	top:218px;
	left:218px;
	background:url('${ctx}/images/turnplate/plate_04.png') top left no-repeat;
...
#gift {
	width:398px;			
	height:89px;
	background:url('${ctx}/images/turnplate/plate_gift_01.png') top left no-repeat;
...
#top-menu-wrapper {
	height:51px;
	background:url('${ctx}/images/turnplate/bg_02.png') top center repeat-x;
	margin-bottom:-51px;
}
...
#top-menu .user {
	...
	height:50px;
	color:#fff;
	background:url('${ctx}/images/turnplate/bg_03.png') 0 16px no-repeat;
}
...
body .ui-widget-overlay {
	background:url('${ctx}/images/turnplate/bg_04.png');
...
<div id="lotteryMsg" class="dn">
	<p class="msg"></p>
	<p class="tips">中奖空间已自动添加到您的快盘帐号中，<a href="http://www.jq-school.com" target="_blank">点击查看</a>。</p>
    <hr class="sp" />
	<p class="mv5" style="margin-bottom:5px">发送以下内容到新浪微博，还可额外获得5M永久空间哦！</p>	
	<div class="content mv5">
		“幸运大转盘，快盘送空间” <span class="option"></span>每日大转盘摇奖，轻松扩容，惊喜不断，抢100G永久空间点击->http://www.jq-school.com/ 同步网盘领军产品，4500万用户的选择，值得信赖。
	</div>
</div>
<!--新登录注册弹框-->
...
<body>
  ...
  <div style="font-size:15px; font-weight:bold; text-align:center; width:450px; line-height:25px; color:#000;">jquery圆盘抽奖特效<br />
     <a href="http://www.jq-school.com" target="_blank" style="color:#000">JquerySchool</a>网站出品（<a href="http://www.jq-school.com" style="color:#000" target="_blank">http://www.jq-school.com</a>）<br />
	  ...
	  <br />
      官方网站学习交流QQ群<a target="_blank" href="http://wp.qq.com/wpa/qunwpa?idkey=f221dd676cd5f7f51f6b580ff8fe1bdd2fefe911ae0e1137a6f79c58d6e11ebf"><img border="0" src="http://pub.idqqimg.com/wpa/images/group.png" alt="Jquery学堂QQ⑧群" title="Jquery学堂QQ⑧群"></a><br /><img src="http://www.jq-school.com//attached/image/20130828/20130828131529_8235.jpg" width="200" height="200" title="JquerySchool微信二维码" alt="JquerySchool微信二维码" />
<br />亲！关注一下呗，转发一下呗，3Q！</div>
...
var turnplate = {
	...
	lottery : function() {
		...
		this.lotteryIndex = parseInt(10*Math.random());
