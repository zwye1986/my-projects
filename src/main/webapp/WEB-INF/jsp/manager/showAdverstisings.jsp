...
-->
				...
				.click(
						function() {
							...
							if (checkedCount == 0) {
							 ...
							 $("#mainForm").attr("action","${ctx}/manager/delAdver").attr("method","post").submit();
						});
			 
			 
			 $("#addBtn").click(function(){
				 $("#mainForm").attr("action","${ctx }/manager/addAdvertise").attr("method","get").submit();
			 });
			 
		 });
		 
		 function deleteSingle(id){
				window.location.href = "${ctx}/manager/delAdver?ids="+id;
			}
			
			function modifyNews(id){
				window.location.href = "${ctx }/manager/toUpdateAdver?ids="+id;
			}
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0"
		...
		<tbody>
			<tr>
				<td height="30"><table width="100%" cellspacing="0"
									...
									style="border-bottom: 1px solid #d5d1c8; border-top: 1px solid #d5d1c8; padding: 0 20px;"><table
										...
										<tbody>
											<tr>
												...
												<td width="100px"><input id="checkAll" type="button"
													class="qx_btn" value="全选" ></td>
												<td width="100px"><input id="addBtn" type="button"
													class="qx_btn" value="新增"></td>
			...
			<tr>
				<td>
					<form action="${ctx }/manager/showAdverstisings" method="get" target="_self"
						...
						<table width="100%" cellspacing="1" cellpadding="0" border="0" id="resList"
							...
							<thead>
								<tr>
									...
									<td width="20%" height="40" bgcolor="e5e6e6" class="STYLE6"><div
											align="center">
											<span class="STYLE10">广告位置说明</span>
										</div></td>
                                    <td width="2%" height="40" bgcolor="e5e6e6" class="STYLE6"><div
                                            align="center">
                                        <span class="STYLE10">序号</span>
                                    </div></td>
									<td width="5%" height="40" bgcolor="e5e6e6" class="STYLE6"><div
											align="center">
											<span class="STYLE10">广告图片宽</span>
										</div></td>
										
										<td width="5%" height="40" bgcolor="e5e6e6" class="STYLE6"><div
											align="center">
											<span class="STYLE10">广告图片高</span>
										</div></td>
										
										<td width="20%" height="40" bgcolor="e5e6e6" class="STYLE6"><div
											align="center">
											<span class="STYLE10">广告链接</span>
										</div></td>
										<td  height="40" bgcolor="e5e6e6" class="STYLE6"><div
											align="center">
											<span class="STYLE10">备注</span>
										</div></td>
									<td width="15%" height="40" bgcolor="e5e6e6" class="STYLE6"><div
											align="center">
								...
								<c:forEach items="${advertisings }" var="item">
									...
									<tr >
										...
										<td height="40" bgcolor="#FFFFFF" class="STYLE6"><div
												align="center">
												<span class="STYLE19">${item.name }</span>
											</div></td>
										<td height="40" bgcolor="#FFFFFF" class="STYLE19"><div
												align="center">${item.adv_position }</div></td>
                                        <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div
                                                align="center">${item.index }</div></td>
										<td height="40" bgcolor="#FFFFFF" class="STYLE19"><div
												align="center">${item.width }</div></td>
												<td height="40" bgcolor="#FFFFFF" class="STYLE19"><div
												align="center">${item.height }</div></td>
												<td height="40" bgcolor="#FFFFFF" class="STYLE19"><div
												align="center">${item.href }</div></td>
												<td height="40" bgcolor="#FFFFFF" class="STYLE19"><div
												align="center">${item.remark }</div></td>
										<td height="40" bgcolor="#FFFFFF" class="STYLE21"><div
												align="center" class="chao_z_btn">
