  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" >
      <tr>
        ...
        <td width="10%" height="40" bgcolor="e2dfd8" class="STYLE6"><div align="center"><span class="STYLE10">类别名称</span></div></td>
      ...
      <c:forEach items="${list }" var="item">
       <tr>
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center"   class="STYLE21"><a style="cursor: pointer;" onclick="changeStatus('${item.id}')">删除</a> | <a style="cursor: pointer;" href="${ctx}/manager/adminCategoryAdd?id=${item.id}"> 修改</a>  </div></td>
      </tr>
      </c:forEach>
