...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$("#addBtn").click(function(){
			window.location.href = "${ctx}/manager/svip/manager";
		});
		
	});

	function showSubs(fatherid){
		$.showPanel("订单详情", "${ctx }/manager/svip/"+fatherid+"/getSubDetails", 850,
				525, true, "${ctx}");
		return;
	}
</script>
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0"
		...
		<tbody>
			...
			<tr>
				<td>
					<form action="${ctx }/manager/svip/getSubs" method="post" target="_self"
								...
								<c:forEach items="${list }" var="item">
									...
									<tr >
										...
										<td height="40" bgcolor="#FFFFFF" class="STYLE19"><div
												...
												<td height="40" bgcolor="#FFFFFF" class="STYLE19"><div
												align="center">${item.myRate }</div></td>
												<td height="40" bgcolor="#FFFFFF" class="STYLE19"><div
										...
										<td height="40" bgcolor="#FFFFFF" class="STYLE21"><div
												...
												<input type="button" value="查看子帐户" onclick="showSubs('${item.id}');">
												<input type="button" value="导出帐号密码" id="exp" onclick="javascript:window.location.href='${ctx}/manager/svip/${item.id }/export'" style="width: 100px">
											</div></td>
									</tr>
								</c:forEach>
