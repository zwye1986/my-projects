...
function add(){
	window.location.href="adminCategoryAdd";
}
...
function changeStatus(a){
	if(confirm("确定删除所选记录吗？")){
		$("#ids").val(a);
		$("#queryListForm").attr("action","${ctx}/manager/adminCategoryDel");
		$("#queryListForm").submit();
	}else{
		return false;
	}
    ...
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="62" bgcolor="#3b3a3f" style="border-bottom:1px solid  #d5d1c8;border-top:1px solid  #d5d1c8; padding:0 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <form id="queryListForm" name="queryListForm" target="_self" action="${ctx }/manager/category" method="post">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" >
        <tr >
          ...
          <td width="15%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">商品类别</span></div></td>
        ...
        <tr>
          ...
          <td height="40" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19">${item.name }</span></div></td>
            ...
            <td height="40" bgcolor="#FFFFFF" class="STYLE21"><div align="center"><a  class="jsxg"style="color:#00ce9b;" onclick="changeStatus('${item.id}')">删除</a> <a onclick="javascript:window.open('${ctx}/manager/adminCategoryAdd?id=${item.id}','rightFrame')"  class="jsxg"style="color:#00ce9b;">修改</a> </div></td>
        </tr>
</c:forEach>
      </table></td>
  </tr>
