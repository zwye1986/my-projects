...
function add(){
	window.location.href="${ctx}/manager/adminActivityAdd";
}
...
function changeStatus(a){
	if(confirm("确定删除所选记录吗？")){
		$("#ids").val(a);
		$("#queryListForm").attr("action","${ctx}/manager/adminActivityDel");
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" >
        <tr >
          ...
          <td width="15%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">活动名称</span></div></td>
          <td width="6%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">活动描述</span></div></td>
          <td width="7%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">开始时间</span></div></td>
          <td width="7%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">结束时间</span></div></td>
          <td width="7%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">活动图片</span></div></td>
        ...
        <tr>
          ...
          <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${item.descrip }</div></td>
          <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><fmt:formatDate value="${item.startTime }" pattern="yyyy-MM-dd" /> </div></td>
          <td height="40" bgcolor="#FFFFFF" class="STYLE21"><div align="center"><fmt:formatDate value="${item.endTime }" pattern="yyyy-MM-dd" /></div></td>
          <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div align="center">
          <c:if test="${item.pic != null && item.pic != '' }">
          <a href="${ctx}/showActivityPic?id=${item.id}" target="_blank">图片地址</a>
          </c:if>
          </div></td>

            <td height="40" bgcolor="#FFFFFF" class="STYLE21"><div align="center"><a  class="jsxg"style="color:#00ce9b;" onclick="changeStatus('${item.id}')">删除</a> <a onclick="javascript:window.open('${ctx}/manager/adminActivityAdd?id=${item.id}','rightFrame')"  class="jsxg"style="color:#00ce9b;">修改</a></div></td>
        </tr>
</c:forEach>
      </table></td>
  </tr>
