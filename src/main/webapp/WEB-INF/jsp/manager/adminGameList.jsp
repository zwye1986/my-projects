    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" >
        ...
        <tr>
          ...
          <td height="40" bgcolor="#FFFFFF"><div align="center" class="STYLE19" >${item.clicks }</div></td>
            ...
            <td height="40" bgcolor="#FFFFFF" class="STYLE21"><div align="center"><a  class="jsxg"style="color:#00ce9b;" onclick="changeStatus('${item.id}')">删除</a> <a onclick="javascript:window.open('${ctx}/manager/adminGameAdd?id=${item.id}','rightFrame')"  class="jsxg"style="color:#00ce9b;">修改</a> <a  onclick="javascript:window.open('${ctx}/manager/adminGamePolicyAdd?gameid=${item.id}','rightFrame')" class="jsxg"style="color:#00ce9b;">游戏策略</a> <a onclick="addRecommend('${item.id}')" class="jsxg"style="color:#00ce9b;">添加推荐</a></div></td>
        </tr>
</c:forEach>
      </table></td>
  </tr>
