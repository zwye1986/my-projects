...
$(function(){
	$("#tj").click(function(){
		$("#gameForm").attr("action","${ctx}/manager/adminProjectTypeDealAdd");
		$("#gameForm").submit();
	});
});
  ...
  <tr>
    <td height="10"></td>
        ...
        <tr>
          ...
          <div class="kv_item"><label class="news_add_list"> 类别名称:</label><input type="text" class="news_txt" name="name" value="${projectType.name }" /></div>
