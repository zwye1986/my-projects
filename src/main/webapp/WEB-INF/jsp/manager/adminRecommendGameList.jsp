	...
	<input type="hidden" name="ids" id="ids" />
		 <input type="hidden" name="sort" id="sort" value="${sort }">
              ...
              <tr>
                ...
                <td><label class="txt">游戏名称：</label>
                  <input class="id" type="text" value="${keyword }" name="keyword"></td>
                
                   <td><input type="button" onclick="recommend()" value="游戏推荐" class="qx_btn2"/></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" >
        <tr >
          ...
          <td width="15%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">游戏名称</span></div></td>
          <td width="6%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">游戏类型</span></div></td>
          ...
          <td width="20%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">排序</span></div></td>
        </tr>
        ...
        <tr>
          ...
          <td height="40" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19">${item.gameName }</span></div></td>
          <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${item.typeName }</div></td>
          ...
          <td height="40" bgcolor="#FFFFFF"><div align="center" class="STYLE19" >${item.clicks }</div></td>
            ...
            <td height="40" bgcolor="#FFFFFF" class="STYLE21"><div align="center"><input type="text" value="${item.recommendOrderBy }" id="${item.gameId}" onkeydown="EnterPress('${item.gameId}')"> <a  class="jsxg"style="color:#00ce9b;" onclick="changeStatus('${item.gameId}')">删除</a></div></td>
        </tr>
</c:forEach>
      </table></td>
  </tr>
