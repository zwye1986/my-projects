...
<option value="${item.id }">${item.name }</option>
                ...
                <td><label class="txt">商品名称：</label>
                  <input class="id" type="text" value="${keyword }" name="keyword"></td>
                    <td width="215"><div align="center" style="height:32px; line-height:32px;"><span class="STYLE1"> <em>积分：</em>
                    <input type="text"  name="minIntegral" class="date" />－<input type="text" name="maxIntegral"  class="date" />
                    </span></div></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" >
        <tr >
          ...
          <td width="15%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">商品名称</span></div></td>
          <td width="6%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">商品类别</span></div></td>
          <td width="7%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">商品价格</span></div></td>
          <td width="7%" height="40" bgcolor="e5e6e6" class="STYLE6"><div align="center"><span class="STYLE10">兑换积分</span></div></td>
        ...
        <tr>
          ...
          <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${item.categoryName }</div></td>
          <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${item.price }</div></td>
          <td height="40" bgcolor="#FFFFFF" class="STYLE21"><div align="center">${item.integral }</div></td>
          <td height="40" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><fmt:formatDate value="${item.addTime }" pattern="yyyy-MM-dd HH:mm:ss"/></div></td>

            <td height="40" bgcolor="#FFFFFF" class="STYLE21"><div align="center"><a  class="jsxg"style="color:#00ce9b;" onclick="changeStatus('${item.id}')">删除</a> <a onclick="javascript:window.open('${ctx}/manager/adminCommodityAdd?id=${item.id}','rightFrame')"  class="jsxg"style="color:#00ce9b;">修改</a> </div></td>
        </tr>
</c:forEach>
      </table></td>
  </tr>
