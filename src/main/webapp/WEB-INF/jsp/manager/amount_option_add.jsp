...
$(function(){
	$("#tj").click(function(){
		$("#gameForm").attr("action","${ctx }/manager/amount/option/save");
		$("#gameForm").submit();
	});
});
</script>
        ...
        <tr>
          <td height="62"  style="border-bottom:2px solid  #d2d2d2;padding:0 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="news_add_t">充值选项金额添加</td>
              </tr>
            </table></td>
        </tr>
      </table></td>
    ...
    <td height="10"></td>
        ...
        <tr>
         ...
         <input type="hidden" name = "id" value="${amountOption.id }" />
          <div class="kv_item"><label class="news_add_list"> 金额:</label><input type="text" class="news_txt" name="optionValue"  value="${amountOption.optionValue }" /></div>
