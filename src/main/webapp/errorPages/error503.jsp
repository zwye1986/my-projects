...
#content {
	...
	z-index: 3;
	margin-top: 35px;
	background:url(${ctx }/images/503.png) no-repeat;
}
#content a{ display:inline-block; width:150px; height:45px; background:url(${ctx }/images/error_back.png) no-repeat; margin-top:393px; margin-left:660px; cursor:pointer;}
