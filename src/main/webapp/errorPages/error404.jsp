...
.Tips {
	width: 947px;
	height: 80px;
	background: url(${ctx }/images/tips.png) no-repeat;
	margin: 0 auto;
}
/*footerwrapper*/
.footwrapper {
...
#content {
	...
	z-index: 3;
	margin-top: 35px;
	background: url(${ctx }/images/404.png) no-repeat;
}
...
#content a {
	...
	width: 150px;
	height: 45px;
	background: url(${ctx }/images/error_back.png) no-repeat;
	margin-top: 410px;
	margin-left: 690px;
	cursor: pointer;
}
...
<body>
		...
		<div class="navbox" style="position: relative;">
			<div id="nav">
				<ul class="nav clearfix">
					...
					<li class="fl"><a
						href="${ctx }/user/account/manager?cate=task">用户中心</a></li>
	...
	<div id="cntwrapper">
		...
		<div id="content">
			<a href="${ctx }/"><img
				src="${ctx }/images/error_back.png" /></a>
		</div>
	</div>
	<!--footer-->
	<div class="footwrapper" style="position: absolute; bottom: 0px;">
		<div class="footer">
			<div class="footerL fl">
				<img src="${ctx }/images/footer_logo.png" />
			</div>
			<div class="footerC fl">
				<div class="footerC_T">
					<a href="${ctx }/help">关于我们 ｜</a> <a
						href="${ctx }/help">新手帮助 ｜ </a> <a
						href="${ctx }/help">友情链接 ｜ </a><a
						href="${ctx }/help">合作伙伴 ｜ </a> <a
						href="${ctx }/help">联系我们</a>
				</div>
				<div class="footerC_B">
					<a href="http://www.miitbeian.gov.cn" target="_blank"
						rel="nofollow">苏ICP备13017605 号 </a> Copyright ©2013
					蛙宝网wowpower.cn版权所有
					<p>增值电信业务经营许可证 A2.B1.B2-201306018 网络文化经营许可证京网文[2013]0168-061号</p>
					<span><a><img src="${ctx }/images/foot01.png" /></a><a><img
							src="${ctx }/images/foot02.png" /></a><a><img
							src="${ctx }/images/foot03.png" /></a><a><img
							src="${ctx }/images/foot04.png" /></a></span>
				</div>
			</div>
			<div class="footerR fr">
				<p>
					<a><img src="${ctx }/images/icon01.png" /></a><a><img
						src="${ctx }/images/icon02.png" /></a><a><img
						src="${ctx }/images/icon03.png" /></a><a><img
						src="${ctx }/images/icon04.png" /></a>
				</p>
			</div>
		</div>
</body>
