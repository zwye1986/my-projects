...
public class NameGenerator {
    ...
    public static void main(String[] args){
    	try {
			NameGenerator nameGenerator = new NameGenerator("/Users/zhangwy/Documents/STSWORKSPACE/wowpower/src/main/webapp/nameOrin.txt");
			System.out.println(nameGenerator.compose(3));
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
