package com.venada.efinance.weixin.common.util;

import com.venada.efinance.weixin.course.pojo.*;
import com.venada.efinance.weixin.message.resp.Article;
import com.venada.efinance.weixin.message.resp.Music;
...
public class AdvancedUtil {
	...
	public static void sendMessageAllUser(String accessToken){
		WeixinUserList weixinUserList = getUserList(accessToken, "");
		Article article1 = new Article();
		article1.setTitle("蛙宝国庆活动");
		article1.setDescription("");
		article1.setPicUrl("http://www.wowpower.cn/images/common/banner_01.jpg");
		article1.setUrl("http://www.wowpower.cn");
		Article article2 = new Article();
		article2.setTitle("微信绑定蛙宝账号方法");
		article2.setDescription("");
		article2.setUrl("http://wowpower.duapp.com/wowpower/weixin/bundlingWeixin");
	...
	public static void main(String args[]) {
		// 获取接口访问凭证
		String accessToken = CommonUtil.getToken("wx9b7cc99bad00853e", "0859e5d77d45e501ed1591f4934b8813").getAccessToken();
//		System.out.println(accessToken);
//		
//		String accessToken="GPop6aucdyW1qzUbzF3g4OiWhAbxwjikCb3dH_OFMwt_M22VlQlHCsAbVssQo6QaA7a_bU7RRmXt4w7PhdTTqg";
//		sendMessageAllUser("GPop6aucdyW1qzUbzF3g4OiWhAbxwjikCb3dH_OFMwt_M22VlQlHCsAbVssQo6QaA7a_bU7RRmXt4w7PhdTTqg");
		sendAllMessage(accessToken,"{\"filter\":{\"group_id\":\"0\"},\"text\":{\"content\":\"测试\"},\"msgtype\":\"text\"}");
		
//		AdvancedUtil.sendCustomMessage("S6Lncchte2b8mdHmikBlVHIgB4OZkfzbg2E-ovlqzd3YxLO_3XtJlJXJ8cjhfvdQVdjSUDFl7eFmG0N0Dffx7w" ,AdvancedUtil.makeTextCustomMessage("3AD41D32-7114-4320-9CC9-3664F460D1FA",
//				DateUtils.currentTime("yyyy-MM-dd HH:mm:ss")+"\n您充值"+100+"成功！"));
		
//		
//		getOauth2AccessToken("wx9b7cc99bad00853e", "efaee485e86eddc388c50274fd8ff288","008e002ada461a44a18e600214f806ab");
//		sendCustomMessage("nHoJH91dMeESPjDNgdRE_J6D4DQ7KgTVB5z26qklku2ZzJJdJz4ekHIMCqAYZ-Bc-1vPGHG-Xq9w--so98ybcw","{\"touser\": \"opgNps4zwjyraSHm5U5pLj1osB1Y\", \"msgtype\": \"text\", \"text\": {\"content\": \"你的账号余额10000.0纳币\"}}");
//
//		/**
//		 * 发送客服消息（文本消息）
//		 */
...
//		list.add(article2);
		// 组装图文客服消息
//		String jsonNewsMsg = makeNewsCustomMessage("opgNps4zwjyraSHm5U5pLj1osB1Y", list);
//		// 发送客服消息
//		sendCustomMessage(accessToken, jsonNewsMsg);
//
//		/**
